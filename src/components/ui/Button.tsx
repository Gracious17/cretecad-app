...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'relative inline-flex items-center justify-center rounded-full font-semibold transition-all duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 overflow-hidden group';
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center gap-2 transition-all duration-300">
        {showArrow && arrowPosition === 'left' && <ArrowIcon direction="left" />}
